...
package metrictest_test // import "github.com/lightstep/otel-launcher-go/lightstep/sdk/metric/metrictest"
...
import (
	...
	"github.com/lightstep/otel-launcher-go/lightstep/sdk/metric/metrictest"
...
var defaultAggregatorConfig = aggregator.Config{}

func TestSyncInstruments(t *testing.T) {
	ctx := context.Background()
	mp, exp := metrictest.NewTestMeterProvider()
	meter := mp.Meter("github.com/lightstep/otel-launcher-go/lightstep/sdk/metric/metrictest/exporter_TestSyncInstruments")
	...
	t.Run("Float Histogram", func(t *testing.T) {
		...
		assert.NoError(t, err)
		assert.EqualValues(t, histogram.NewFloat64(defaultAggregatorConfig.Histogram, 4, 5), out.Aggregation)
	})
	...
	t.Run("Int Histogram", func(t *testing.T) {
		...
		assert.NoError(t, err)
		assert.EqualValues(t, histogram.NewInt64(defaultAggregatorConfig.Histogram, 24, 25), out.Aggregation)
	})
}
...
func TestSyncDeltaInstruments(t *testing.T) {
	...
	meter := mp.Meter("github.com/lightstep/otel-launcher-go/lightstep/sdk/metric/metrictest/exporter_TestSyncDeltaInstruments")
...
func TestAsyncInstruments(t *testing.T) {
	...
	t.Run("Float Counter", func(t *testing.T) {
		meter := mp.Meter("github.com/lightstep/otel-launcher-go/lightstep/sdk/metric/metrictest/exporter_TestAsyncCounter_FloatCounter")
	...
	t.Run("Float UpDownCounter", func(t *testing.T) {
		meter := mp.Meter("github.com/lightstep/otel-launcher-go/lightstep/sdk/metric/metrictest/exporter_TestAsyncCounter_FloatUpDownCounter")
	...
	t.Run("Float Gauge", func(t *testing.T) {
		meter := mp.Meter("github.com/lightstep/otel-launcher-go/lightstep/sdk/metric/metrictest/exporter_TestAsyncCounter_FloatGauge")
	...
	t.Run("Int Counter", func(t *testing.T) {
		meter := mp.Meter("github.com/lightstep/otel-launcher-go/lightstep/sdk/metric/metrictest/exporter_TestAsyncCounter_IntCounter")
	...
	t.Run("Int UpDownCounter", func(t *testing.T) {
		meter := mp.Meter("github.com/lightstep/otel-launcher-go/lightstep/sdk/metric/metrictest/exporter_TestAsyncCounter_IntUpDownCounter")
	...
	t.Run("Int Gauge", func(t *testing.T) {
		meter := mp.Meter("github.com/lightstep/otel-launcher-go/lightstep/sdk/metric/metrictest/exporter_TestAsyncCounter_IntGauge")
...
func ExampleExporter_GetByName() {
	mp, exp := metrictest.NewTestMeterProvider()
	meter := mp.Meter("github.com/lightstep/otel-launcher-go/lightstep/sdk/metric/metrictest/exporter_ExampleExporter_GetByName")
	...
	fmt.Println(number.ToFloat64(out.Aggregation.(aggregation.Sum).Sum()))
	// Output: 2.5
}

func ExampleExporter_GetByNameAndAttributes() {
	mp, exp := metrictest.NewTestMeterProvider()
	meter := mp.Meter("github.com/lightstep/otel-launcher-go/lightstep/sdk/metric/metrictest/exporter_ExampleExporter_GetByNameAndAttributes")
