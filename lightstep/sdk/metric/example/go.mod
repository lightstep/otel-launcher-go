...
require (
	...
	github.com/open-telemetry/otel-arrow v0.17.0 // indirect
	github.com/open-telemetry/otel-arrow/collector v0.17.0 // indirect
	github.com/open-telemetry/otel-arrow/collector/exporter/otelarrowexporter v0.17.0 // indirect
	github.com/open-telemetry/otel-arrow/collector/processor/concurrentbatchprocessor v0.17.0 // indirect
