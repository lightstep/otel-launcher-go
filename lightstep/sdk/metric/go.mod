...
require (
	...
	github.com/open-telemetry/otel-arrow/collector/processor/concurrentbatchprocessor v0.18.0
	github.com/open-telemetry/otel-arrow/collector/receiver/otelarrowreceiver v0.18.0
