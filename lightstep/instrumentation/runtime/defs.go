...
func expectRuntimeMetrics() *builtinDescriptor {
	...
	bd.singleHistogram("/gc/heap/allocs-by-size:bytes")
	bd.singleHistogram("/gc/heap/frees-by-size:bytes")
	bd.singleHistogram("/gc/pauses:seconds")
	bd.singleHistogram("/sched/latencies:seconds")
